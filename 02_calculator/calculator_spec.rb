...
describe "#multiply" do
  ...
  it "multiplies two numbers" do
    ...
    multiply(2.5,4).should be_within(0.001).of(10)
  end
  it "multiplies several numbers" do
    multiply(2,3,9,4).should == 216
    multiply(1.0,2.0,5.5).should be_within(0.01).of(11)
  end
end
...
describe "#power" do
  ...
  it "raises fractional powers" do
    power(1.4,2.9).should be_within(0.001).of(2.65321)
  end
  it "raises negative powers" do
    power(4,-2).should be_within(0.0001).of(0.0625)
  end
end
